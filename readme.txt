...
Contributors: peentify
Tags: peentify, woocommerce, peentify-woocommerce, integration, Woocommerce with peentify
Donate link: https://github.com/abderrazzak-oxa
...
<b>Peentify-woocommerce</b> is a wordpress plugin for link your peentify system to woocommerce store

== Description ==
Firstly Peentify system is a script for e-commerce owners cash on delivery, Peentify will help you manage orders, expenses, payments and also the team work.
and this is a WooCommerce plugin that helps to integrate your peentify system with woocommerce store. when there is a new order checkout , this plugin will send the order to your peentify system.

== Screenshots ==

1. Peentify WooCommerce Settings
2. WooCommerce Product Data
3. Generate API From Your Peentify System
4. Orders In Peentify System
